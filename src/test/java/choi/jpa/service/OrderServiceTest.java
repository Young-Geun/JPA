...
import choi.jpa.domain.item.Book;
import choi.jpa.domain.item.Item;
import choi.jpa.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    public void 상품주문() throws Exception {
        ...
        Book book = createBook("JPA 기본", 10_000, 10);
    ...
    public void 상품주문_재고수량초과() throws Exception {
        // given
        Member member = createMember();
        Item item = createBook("JPA 기본", 10_000, 10);
    ...
    public void 주문취소() throws Exception {
        // given
        Member member = createMember();
        Book item = createBook("JPA 기본", 10_000, 10);
    ...
    private Member createMember() {
        ...
        member.setName("회원");
        member.setAddress(new Address("경기", "대왕판교로", "123-123"));
        em.persist(member);
        return member;
    }
